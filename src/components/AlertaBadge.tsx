...
import { EstadoAlerta as TipoEstadoAlerta } from '@/types/alertas/Alerta';
...
interface AlertaBadgeProps extends Omit<React.ComponentProps<'span'>, 'children'>, VariantProps<typeof alertaBadgeVariants> {
  estado: string | TipoEstadoAlerta;
  mostrarTexto?: boolean;
  asChild?: boolean;
}

function obtenerConfiguracionEstado(estado: string | TipoEstadoAlerta) {
