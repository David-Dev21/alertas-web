...
interface DataTableProps<TData, TValue> {
  ...
  onRefrescar?: () => void;
  onFiltrarDepartamento?: (idDepartamento: string) => void;
  departamentoFiltro?: string;
}

export function TablaPersonal<TData, TValue>({
  columnas,
  datos,
  cargando = false,
  paginacion,
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-2">
          <div className="relative">
            ...
            <Input
              placeholder="Buscar por grado, nombre completo, unidad o escalafón"
              value={busqueda}
              onChange={(event) => manejarBusqueda(event.target.value)}
              className="pl-8 w-96"
            />
          </div>
          <Select value={departamentoFiltro || "TODOS"} onValueChange={onFiltrarDepartamento}>
            ...
            <SelectContent>
              ...
              <SelectItem value="2">ORURO</SelectItem>
              <SelectItem value="3">POTOSÍ</SelectItem>
              <SelectItem value="4">COCHABAMBA</SelectItem>
              <SelectItem value="5">CHUQUISACA</SelectItem>
              <SelectItem value="6">TARIJA</SelectItem>
              <SelectItem value="7">SANTA CRUZ</SelectItem>
        ...
        <div className="flex items-center justify-between py-4">
          <div className="flex items-center space-x-2">
            <p className="text-sm text-muted-foreground">
              Mostrando {Math.min(paginacion.elementosPorPagina, paginacion.totalElementos)} de {paginacion.totalElementos} personal
            </p>
          </div>
          <div className="flex items-center space-x-2">
